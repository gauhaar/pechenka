    ...
    <div className="bg-black text-white">
      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-32 pb-20 flex flex-col md:flex-row gap-8">
        ...
        <main className="flex-grow">
          <PolicyNotice />
          <h1 className="text-4xl font-bold mb-8">Terms of Service SLNC-env</h1>
          <div className="space-y-8">
            <section id="download">
              <h2 className="text-2xl font-semibold mb-4">Policy Document</h2>
              <p className="mb-4">
                The content for the Terms of Service SLNC-env is available for download.
              </p>
              <a 
                ...
                download
              >
                Download Terms of Service (DOCX)
              </a>
            </section>
          </div>
        </main>
